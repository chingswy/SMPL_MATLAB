...
shapedirs_vec = reshape(shapedirs.x, 6890 * 3, 10);
v_tem_vec = reshape(v_template, 6890 * 3, 1);
zeros_24x6890 = sparse(K, N);
J_reg_vec = [J_regressor, zeros_24x6890, zeros_24x6890;
        zeros_24x6890, J_regressor, zeros_24x6890;
        zeros_24x6890, zeros_24x6890, J_regressor];

%%
if 1
    patch('Faces', faces, 'Vertices', v_template, 'FaceColor', 'w')
    view(3)
    axis equal
end
%% input parameters
